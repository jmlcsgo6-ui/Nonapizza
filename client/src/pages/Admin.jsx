                ...
                <div className="container auth-container" style={{maxWidth: '450px'}}>
                    ...
                    >
                        <div className="section-header text-center auth-header">
                            <div style={{display:'inline-flex', marginBottom:'15px', padding: '15px', borderRadius: '15px', background: 'rgba(255, 94, 0, 0.1)', border: '1px solid rgba(255, 94, 0, 0.2)'}}>
                                <ChefHat size={32} style={{color: 'var(--primary)'}} />
                            </div>
                            <h2 className="section-title">Nona Admin</h2>
                            <p className="section-subtitle">Acesso restrito ao painel da loja</p>
                        </div>
                        ...
                        <div className="auth-card">
                            <form onSubmit={handleLogin}>
                                ...
                                <div className="form-group">
                                    <label style={{fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: '8px', display: 'block'}}>
                                        Email
                                    </label>
                                    <input
                                        type="email"
                        ...
                        <div className="text-center mt-4">
                            <a href="/" className="btn-text" style={{textDecoration: 'none'}}>
                                <i className="fa-solid fa-arrow-left" style={{ marginRight: '8px' }}></i> Voltar ao site
                            </a>
                        </div>
                    </motion.div>
                </div>
