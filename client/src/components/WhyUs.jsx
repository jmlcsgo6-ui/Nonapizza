            ...
            <div className="container">
                <div className="why-grid">
                    <div className="why-content">
                        ...
                        <p className="section-subtitle">Não é apenas pizza, é uma experiência gastronômica superior na sua
                            casa.</p>
                        ...
                        <div className="benefit-block hover-scale">
                            ...
                            <div className="benefit-text">
                                ...
                                <p>Farinha 00 importada e fermentação natural de 48 horas para uma massa leve e de fácil
                                    digestão.</p>
                            </div>
                        </div>
                        <div className="benefit-block hover-scale">
                            ...
                            <div className="benefit-text">
                                ...
                                <p>Tudo calculado para que sua pizza saia do forno diretamente para as mãos do
                                    entregador.</p>
                            </div>
                        </div>
                        <div className="benefit-block hover-scale">
