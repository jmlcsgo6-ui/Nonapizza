        ...
        <section id="explore" className="section bg-alt reveal-on-scroll">
            <div className="container">
                <div className="section-header text-center">
                    <h2 className="section-title">Sua Fome, Suas Regras</h2>
                    <p className="section-subtitle">Escolha como deseja se deliciar com as receitas da Nona.</p>
                </div>

                <div className="dual-action-grid">
                    <div className="action-card promo-builder hover-scale" style={{ cursor: 'pointer' }} onClick={() => setIsBuilderOpen(true)}>
                    ...
                    <div className="action-card promo-menu hover-scale" style={{ cursor: 'pointer' }} onClick={openMenu}>
                        <div className="ac-overlay"></div>
                        <div className="ac-content">
